            ...
            <div className='container-fluid'>
                ...
                >
                    <Toast>
                        ...
                        <ToastBody className='display-3'>
                            {(this.state.h - 6) % 24}:{this.state.m}:
                            {this.state.s}
                        </ToastBody>
                    </Toast>
                </div>
                ...
                >
                    <Toast>
                        ...
                        <ToastBody className='display-3'>
                            {(this.state.h + 2) % 24}:{this.state.m}:
                            {this.state.s}
                        </ToastBody>
                    </Toast>
                </div>
                ...
                >
                    <Toast>
                        ...
                        <ToastBody className='display-3'>
                            {(this.state.h + 10) % 24}:{this.state.m}:
                            {this.state.s}
                        </ToastBody>
                    </Toast>
                </div> */}
                ...
                >
                    <Toast>
                        ...
                        <ToastBody className='display-3'>
                            {(this.state.h + 1) % 24}:{this.state.m}:
                            {this.state.s}
                        </ToastBody>
                    </Toast>
                </div>
                ...
                >
                    <Toast>
                        ...
                        <ToastBody className='display-3'>
                            {(this.state.h - 3) % 24}:{this.state.m}:
                            {this.state.s}
                        </ToastBody>
                    </Toast>
                </div>
                ...
                >
                    <Toast>
                        ...
                        <ToastBody className='display-3'>
                            {(this.state.h + 5) % 24}:
                            {this.minuteConverter((this.state.m + 30) % 60)}:
                            {this.state.s}
                        </ToastBody>
                    </Toast>
                </div> */}
